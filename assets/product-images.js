...
class ProductImages extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.initVariants()
    // Initialize image zoom on all viewports (desktop + mobile)
    this.initImageZoom()
  ...
  initImageZoom() {
    ...
    try {
      ...
      if (this.photoswipe) {
        ...
        console.info('Photoswipe not initialized (data-zoom=', container.dataset.zoom, ') for section', this.sectionId)
      }
    } catch (err) {
      console.error('Error initializing Photoswipe for section', this.sectionId, err)
    }
