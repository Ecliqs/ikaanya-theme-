class ColorSwatches extends HTMLElement {
  ...
  if (!this.gridItemLink) return

  this.gridProductImageWrap =
    this.gridItemLink.querySelector(this.selectors.gridProductImageWrap)

  if (!this.gridProductImageWrap) return

  this.colorImages =
    this.gridProductImageWrap.querySelectorAll(this.selectors.colorSwatchImage)
